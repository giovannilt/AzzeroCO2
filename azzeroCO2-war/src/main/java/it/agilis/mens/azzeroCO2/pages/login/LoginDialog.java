package it.agilis.mens.azzeroCO2.pages.login;
...
public class LoginDialog extends Dialog {
    ...
    public LoginDialog() {
       ...
       /* BeanModelFactory factory = BeanModelLookup.get().getFactory(UserInfo.class);
        UserInfo userInfo = new UserInfo();
        BeanModel userInfoModel = factory.createModel(userInfo);

        Store<BeanModel> store= new ListStore<BeanModel>();
        store.addFilter((StoreFilter<BeanModel>) userInfoModel);
*/
