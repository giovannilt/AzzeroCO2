...
import it.agilis.mens.azzeroCO2.shared.model.Coefficiente;
 ...
 */
public class AmministrazioneCoeffPage extends LayoutContainer {
    ...
    protected void onRender(Element parent, int index) {
        ...
        createCentre();
        centre.setHeading("Gestione coefficienti");
