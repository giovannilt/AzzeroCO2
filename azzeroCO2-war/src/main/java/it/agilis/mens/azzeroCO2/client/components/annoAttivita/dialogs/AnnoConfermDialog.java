 ...
 */
public class AnnoConfermDialog extends Dialog {

    protected Button ok;
    protected Button cancel;

    public AnnoConfermDialog() {

        setHeading("Annulla il Calcolo dell'Anno di attivita' in corso");
    ...
    protected void createButtons() {
        ...
        ok.addSelectionListener(new SelectionListener<ButtonEvent>() {
            public void componentSelected(ButtonEvent ce) {
                ...
                Dispatcher.forwardEvent(UnAnnoDiAttivitaEvents.ClearPanel, Eventi.MAIN);
                hide();
            }
        });
