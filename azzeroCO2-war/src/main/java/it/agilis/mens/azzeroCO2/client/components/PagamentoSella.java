...
public class PagamentoSella extends Dialog {
    ...
    public Text getTesto() {
        Text testo = new Text("Alla fine del processo di pagamento, sulla pagina della banca, ricordati di premere il pulsante <u><b>fine</b></u>. <br>Solo in questo modo AzzeroCO2 riceverà conferma dell'avvenuto pagamento.");
